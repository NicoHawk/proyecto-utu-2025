...
class Auto {
    ...
    public function insertarUsuario($usuario, $modelo, $marca, $conector, $autonomia, $anio) {
        $sql = "INSERT INTO autos (usuario, modelo, marca, conector, autonomia, anio) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $this->conexion->prepare($sql);
        return $stmt->execute([$usuario, $modelo, $marca, $conector, $autonomia, $anio]);
    }

    public function actualizarUsuario($id, $usuario, $modelo, $marca, $conector, $autonomia, $anio) {
    ...
    public function actualizarAdmin($id, $modelo, $marca, $conector, $autonomia, $anio) {
